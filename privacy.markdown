---
layout: site
title: Privacy Policy | Blockchain API
description: Read our privacy policy to learn how we protect your data and privacy while providing secure and reliable Blockchain API.
...
The party responsible for this website (the "controller") for purposes of data protection law can be found [here](/imprint).
