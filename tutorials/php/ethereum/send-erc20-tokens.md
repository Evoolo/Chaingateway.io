...
{% highlight php linenos %}
    ...
    $ch = curl_init("https://api.chaingateway.io/v2/ethereum/transactions/erc20");

    $payload = json_encode( array("ethereumaddress" => $ethereumaddress, "contractaddress" => $contractaddress) );
