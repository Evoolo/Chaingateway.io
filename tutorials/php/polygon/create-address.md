---
layout: tutorials
title: Polygon Tutorial to create adresses with PHP
permalink: /tutorials/php-polygon-create-address/
---
...
{% highlight php linenos %}
    ...
    $password = "PASSWORD"; // Secure password for the Polygon address you are creating
    # -------------------------------------------------------
    ...
    CURLOPT_URL => 'https://api.chaingateway.io/v2/polygon/addresses',
